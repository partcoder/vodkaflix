    ...
    <div key={movie.id} className="relative h-[95vh] w-full text-white overflow-hidden bg-[#050505]">
      ...
      <div className="absolute bottom-[35%] md:bottom-[25%] left-6 md:left-16 max-w-3xl space-y-6 z-10 pr-4 animate-[scaleIn_0.6s_cubic-bezier(0.16,1,0.3,1)]">
        ...
        <div className="flex items-center gap-3 opacity-0 animate-[fadeIn_0.5s_0.2s_forwards]">
             <span className="px-3 py-1 text-xs font-bold tracking-widest uppercase bg-white/10 backdrop-blur-md border border-white/10 rounded-full text-red-500 shadow-[0_0_15px_rgba(220,38,38,0.3)]">
                 Featured
             </span>
             <span className="px-3 py-1 text-xs font-bold tracking-widest uppercase bg-white/5 backdrop-blur-md border border-white/5 rounded-full text-gray-300">
        ...
        <div className="flex flex-wrap items-center gap-4 pt-6">
          ...
          <button 
            ...
            className="relative flex items-center gap-3 px-8 py-4 ios-glass text-white rounded-full transition-all transform hover:scale-105 active:scale-95 hover:bg-white/20 group"
          >
           ...
           <button 
            onClick={onRefresh}
            className="flex items-center justify-center w-14 h-14 ios-glass text-white/70 rounded-full hover:text-white hover:rotate-180 transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:bg-white/10 active:scale-95"
          >
            <RefreshCw size={20} />
          </button>
        </div>
