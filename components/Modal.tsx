  ...
  return (
    <div className="fixed inset-0 z-[60] overflow-y-auto custom-scrollbar" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      ...
      <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-6">
        ...
        <div 
            className="relative w-full max-w-4xl transform overflow-hidden rounded-[2rem] bg-[#0f0f0f] text-left shadow-[0_0_50px_rgba(0,0,0,0.5)] transition-all animate-[scaleIn_0.3s_cubic-bezier(0.2,0.8,0.2,1)] ring-1 ring-white/10"
                ...
                <div className="absolute bottom-0 left-0 p-8 z-10 w-full md:w-3/4">
                    ...
                    <div className="flex items-center gap-4 pt-2">
                        ...
                        <button 
                            ...
                            className={`p-2.5 rounded-full border transition-all duration-300 hover:scale-110 active:scale-95 ${isInList ? 'bg-green-600 border-green-500 text-white shadow-[0_0_15px_rgba(22,163,74,0.4)]' : 'bg-white/10 border-white/10 backdrop-blur-md text-white hover:bg-white/20'}`}
                        >
                        ...
                        <button 
                            ...
                            className={`p-2.5 rounded-full border transition-all duration-300 hover:scale-110 active:scale-95 ${isLiked ? 'bg-white text-red-600 border-white shadow-[0_0_15px_rgba(255,255,255,0.4)]' : 'bg-white/10 border-white/10 backdrop-blur-md text-white hover:bg-white/20'}`}
                        >
